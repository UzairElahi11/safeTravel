...
//        callCompletion(null, false, completion);
  ...
  static void deleteAccount(
   ...
   static void setSubScription(
    ...
    Map<String, dynamic> json = {"payment_method_id": paymentMethodId, "price_id": planId};
    callPostApi(UrlConstants.setSubScription, _defaultHeader(), json, completion);
  }
  static void getPromoCode(
   ...
   static void activateReferalCode(
      String code,ResponseCompletion completion) {
    Map<String, dynamic> json = {"code": code};
    callPostApi(UrlConstants.activateReferalCode, _defaultHeader(), json, completion);
  }
}
